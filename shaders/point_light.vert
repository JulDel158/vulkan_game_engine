...
void main() {
	...
	vec4 lightInCameraSpace = ubo.view * vec4(ubo.pLightPosition, 1.0);
	vec4 positionInCamSpace = lightInCameraSpace + LIGHT_RADIUS * vec4(fragOffset, 0.0, 0.0);
...
//
//	vec3 positionWorld = ubo.pLightPosition.xyz 
