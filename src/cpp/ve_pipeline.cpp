...
namespace ve {
	...
	void ve_pipeline::createGraphicsPipeline(
		...
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE &&
			"Cannot create graphics pipeline:: no pipelineLayout provided in confiInfo");
	...
	void ve_pipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
	{
		...
		configInfo.bindingDescriptions = ve_model::Vertex::getBindingDescriptions();
		configInfo.attributeDescriptions = ve_model::Vertex::getAttributeDescriptions();
	}
